...
public class ZKClient implements Watcher{
     ...
     * @return boolean
     */
    private boolean createNode(String path, String data, List<ACL> acl, CreateMode createMode) {
        try {
     ...
     * @return boolean
     */
    private boolean updateNode(String path, String data) {
        try {
     ...
     * @return String
     */
    private String getNodeData(String path, boolean needWatch) {
        try {
